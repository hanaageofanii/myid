...
class tkr
{
   /**
     ...
     */
    public function view(User $user, tkr $tkr): bool
    {
     ...
     */
    public function update(User $user, tkr $tkr): bool
    {
     ...
     */
    public function delete(User $user, tkr $tkr): bool
    {
        return $user->hasRole(['admin']);
    }
     ...
     */
    public function restore(User $user, tkr $tkr): bool
    {
        return $user->hasRole(['admin']);
    }
     ...
     */
    public function forceDelete(User $user, tkr $tkr): bool
    {
        return $user->hasRole(['admin']);
    }
}
