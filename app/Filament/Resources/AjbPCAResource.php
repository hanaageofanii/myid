...
use App\Filament\Resources\AjbPCAResource\Pages;
use App\Filament\Resources\AjbPCAResource\RelationManagers;
...
class AjbPCAResource extends Resource
{
    ...
    protected static ?string $title = "AJB PCA";
    protected static ?string $navigationGroup = "Legal - Pajak";
    protected static ?string $pluralLabel = "AJB PCA";
    protected static ?string $navigationIcon = 'heroicon-o-document';
    protected static ?string $navigationLabel = 'AJB PCA';
    protected static ?string $pluralModelLabel = 'Daftar AJB PCA';
