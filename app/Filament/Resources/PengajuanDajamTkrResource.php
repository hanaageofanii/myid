...
use App\Filament\Resources\PengajuanDajamTkrResource\Pages;
use App\Filament\Resources\PengajuanDajamTkrResource\RelationManagers;
...
class PengajuanDajamTkrResource extends Resource
{
    protected static ?string $model = PengajuanDajamTkr::class;

    protected static ?string $title = "Form Pengajuan Dajam TKR";
    protected static ?string $navigationGroup = "Legal";
    protected static ?string $pluralLabel = "Data Pengajuan Dajam TKR";
    protected static ?string $navigationLabel = "Pengajuan Dajam TKR";
    protected static ?string $pluralModelLabel = 'Daftar Pengajuan Dajam TKR';
    ...
    {
        return [
            'index' => Pages\ListPengajuanDajamTkrs::route('/'),
            'create' => Pages\CreatePengajuanDajamTkr::route('/create'),
            'edit' => Pages\EditPengajuanDajamTkr::route('/{record}/edit'),
        ];
    }
}
