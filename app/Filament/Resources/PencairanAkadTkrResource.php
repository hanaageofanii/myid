...
use App\Filament\Resources\PencairanAkadTkrResource\Pages;
use App\Filament\Resources\PencairanAkadTkrResource\RelationManagers;
...
class PencairanAkadTkrResource extends Resource
{
    protected static ?string $model = PencairanAkadTkr::class;

    protected static ?string $title = "Form Input Data Pencairan Akad TKR";
    protected static ?string $navigationGroup = "Keuangan";
    protected static ?string $pluralLabel = "Data Pencairan Akad TKR";
    protected static ?string $navigationLabel = "Pencairan Akad TKR";
    protected static ?string $pluralModelLabel = 'Daftar Pencairan TKR';
            ...
            ->schema([
                Select::make('siteplan')
                    ...
                    ->afterStateUpdated(function ($state, callable $set) {
                        if ($state) {
                            $data = FormKprTkr::where('siteplan', $state)->first(); 
                            if ($data) {
    ...
    {
        return [
            'index' => Pages\ListPencairanAkadTkrs::route('/'),
            'create' => Pages\CreatePencairanAkadTkr::route('/create'),
            'edit' => Pages\EditPencairanAkadTkr::route('/{record}/edit'),
        ];
    }
}
