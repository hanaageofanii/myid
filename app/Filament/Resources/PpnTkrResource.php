...
use App\Filament\Resources\PpnTkrResource\Pages;
use App\Filament\Resources\PpnTkrResource\RelationManagers;
use App\Models\PpnTkr;
use Filament\Forms;
...
class PpnTkrResource extends Resource
{
    protected static ?string $model = PpnTkr::class;

    protected static ?string $title = "Form Data Faktur PPN TKR";
    protected static ?string $navigationGroup = "Legal - Pajak";
    protected static ?string $pluralLabel = "Data Faktur PPN TKR";
    protected static ?string $navigationLabel = "Faktur PPN TKR";
    protected static ?string $pluralModelLabel = 'Daftar Faktur PPN TKR';
...
public static function getEloquentQuery(): Builder
{
    ...
    {
        return [
            'index' => Pages\ListPpnTkrs::route('/'),
            'create' => Pages\CreatePpnTkr::route('/create'),
            'edit' => Pages\EditPpnTkr::route('/{record}/edit'),
        ];
    }
}
