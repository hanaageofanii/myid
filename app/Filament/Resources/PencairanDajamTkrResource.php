...
use App\Filament\Resources\PencairanDajamTkrResource\Pages;
use App\Filament\Resources\PencairanDajamTkrResource\RelationManagers;
...
class PencairanDajamTkrResource extends Resource
{
    protected static ?string $model = PencairanDajamTkr::class;

    protected static ?string $title = "Form Pencairan Dajam TKR";
    protected static ?string $navigationGroup = "Keuangan";
    protected static ?string $pluralLabel = "Data Pencairan Dajam TKR";
    protected static ?string $navigationLabel = "Pencairan Dajam TKR";
    protected static ?string $pluralModelLabel = 'Daftar Pencairan Dajam TKR';
                ...
                ->schema([
                    Select::make('siteplan')
                        ...
                        ->afterStateUpdated(function ($state, callable $set) {
                            ...
                            $pengDajam = PengajuanDajamTkr::where('siteplan', $state)->first();
...
public static function getRelations(): array
{
    ...
    {
        return [
            'index' => Pages\ListPencairanDajamTkrs::route('/'),
            'create' => Pages\CreatePencairanDajamTkr::route('/create'),
            'edit' => Pages\EditPencairanDajamTkr::route('/{record}/edit'),
        ];
    }
}
