...
use App\Filament\Resources\PencairanAkadPcaResource\Pages;
use App\Filament\Resources\PencairanAkadPcaResource\RelationManagers;
use App\Models\PencairanAkadPca;
use Filament\Forms;
...
class PencairanAkadPcaResource extends Resource
{
    protected static ?string $model = pencairan_akad_pca::class;

    protected static ?string $title = "Form Input Data Pencairan Akad PCA";
    protected static ?string $navigationGroup = "Keuangan";
    protected static ?string $pluralLabel = "Data Pencairan Akad PCA";
    protected static ?string $navigationLabel = "Pencairan Akad PCA";
    protected static ?string $pluralModelLabel = 'Daftar Pencairan PCA';
            ...
            ->schema([
                Select::make('siteplan')
                    ...
                    ->afterStateUpdated(function ($state, callable $set) {
                        if ($state) {
                            $data = form_kpr_pca::where('siteplan', $state)->first(); 
                            if ($data) {
    ...
    {
        return [
            'index' => Pages\ListPencairanAkadPcas::route('/'),
            'create' => Pages\CreatePencairanAkadPca::route('/create'),
            'edit' => Pages\EditPencairanAkadPca::route('/{record}/edit'),
        ];
    }
}
