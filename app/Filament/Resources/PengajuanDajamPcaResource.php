...
use App\Filament\Resources\PengajuanDajamPcaResource\Pages;
use App\Filament\Resources\PengajuanDajamPcaResource\RelationManagers;
...
class PengajuanDajamPcaResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListPengajuanDajamPcas::route('/'),
            'create' => Pages\CreatePengajuanDajamPca::route('/create'),
            'edit' => Pages\EditPengajuanDajamPca::route('/{record}/edit'),
        ];
    }
}
