...
{
    protected static ?string $model = form_pajak_pca::class;

    protected static ?string $title = "Form Validasi PPH PCA";

    protected static ?string $navigationGroup = "Legal - Pajak";

    protected static ?string $pluralLabel = "Data Validasi PPH PCA";

    protected static ?string $navigationLabel = "Validasi PPH PCA";

    protected static ?string $pluralModelLabel = 'Daftar Validasi PPH PCA';
