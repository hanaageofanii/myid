...
use App\Filament\Resources\PencarianDajamPcaResource\Pages;
use App\Filament\Resources\PencarianDajamPcaResource\RelationManagers;
use App\Models\PencarianDajamPca;
use Filament\Forms;
...
class PencarianDajamPcaResource extends Resource
{
    protected static ?string $model = pencairan_dajam_pca::class;

    protected static ?string $title = "Form Pencairan Dajam PCA";
    protected static ?string $navigationGroup = "Keuangan";
    protected static ?string $pluralLabel = "Data Pencairan Dajam PCA";
    protected static ?string $navigationLabel = "Pencairan Dajam PCA";
    protected static ?string $pluralModelLabel = 'Daftar Pencairan Dajam PCA';
    ...
    {
        return [
            'index' => Pages\ListPencarianDajamPcas::route('/'),
            'create' => Pages\CreatePencarianDajamPca::route('/create'),
            'edit' => Pages\EditPencarianDajamPca::route('/{record}/edit'),
        ];
    }
}
