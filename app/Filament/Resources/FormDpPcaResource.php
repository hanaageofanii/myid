...
use App\Filament\Resources\FormDpPcaResource\Pages;
use App\Filament\Resources\FormDpPcaResource\RelationManagers;
...
class FormDpPcaResource extends Resource
{
    protected static ?string $model = form_dp_pca::class;

    protected static ?string $title = "Data Uang Muka PCA";
    protected static ?string $navigationGroup = "Keuangan";
    protected static ?string $pluralLabel = "Data Uang Muka PCA";
    protected static ?string $navigationLabel = "Uang Muka PCA";
    protected static ?string $pluralModelLabel = 'Daftar Uang Muka PCA';
...
public static function getEloquentQuery(): Builder
{
    ...
    {
        return [
            'index' => Pages\ListFormDpPcas::route('/'),
            'create' => Pages\CreateFormDpPca::route('/create'),
            'edit' => Pages\EditFormDpPca::route('/{record}/edit'),
        ];
    }
}
