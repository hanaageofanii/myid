...
use App\Filament\Resources\PajakTkrResource\Pages;
use App\Filament\Resources\PajakTkrResource\RelationManagers;
use Filament\Forms;
...
class PajakTkrResource extends Resource
{
    protected static ?string $model = PajakTkr::class;

    protected static ?string $title = "Form Validasi PPH TKR";

    protected static ?string $navigationGroup = "Legal - Pajak";

    protected static ?string $pluralLabel = "Data Validasi PPH TKR";

    protected static ?string $navigationLabel = "Validasi PPH TKR";

    protected static ?string $pluralModelLabel = 'Daftar Validasi PPH TKR';
    ...
    public static function form(Form $form): Form
    {
        ...
        ->schema([
            ...
            ->label('Blok')
            ->nullable()
            ->options(fn() => FormKprTkr::pluck('siteplan', 'siteplan')->toArray())
            ->reactive()
            ...
            ->afterStateUpdated(function ($state, callable $set) {
                ...
                if ($kprData) {
                    ...
                    $legalData = LegalTkr::where('siteplan', $state)->first();
                    if ($legalData) {
    ...
    {
        return [
            'index' => Pages\ListPajakTkrs::route('/'),
            'create' => Pages\CreatePajakTkr::route('/create'),
            'edit' => Pages\EditPajakTkr::route('/{record}/edit'),
        ];
    }
}
