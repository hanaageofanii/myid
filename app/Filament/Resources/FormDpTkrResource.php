...
use App\Filament\Resources\FormDpTkrResource\Pages;
use App\Filament\Resources\FormDpTkrResource\RelationManagers;
...
class FormDpTkrResource extends Resource
{
    protected static ?string $model = FormDpTkr::class;

    protected static ?string $title = "Data Uang Muka TKR";
    protected static ?string $navigationGroup = "Keuangan";
    protected static ?string $pluralLabel = "Data Uang Muka TKR";
    protected static ?string $navigationLabel = "Uang Muka TKR";
    protected static ?string $pluralModelLabel = 'Daftar Uang Muka TKR';
    ...
    {
        return [
            'index' => Pages\ListFormDpTkrs::route('/'),
            'create' => Pages\CreateFormDpTkr::route('/create'),
            'edit' => Pages\EditFormDpTkr::route('/{record}/edit'),
        ];
    }
}
