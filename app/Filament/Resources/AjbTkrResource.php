...
use App\Filament\Resources\AjbTkrResource\Pages;
use App\Filament\Resources\AjbTkrResource\RelationManagers;
...
class AjbTkrResource extends Resource
{
    protected static ?string $model = AjbTkr::class;

    protected static ?string $title = "AJB";
    protected static ?string $navigationGroup = "Legal";
    protected static ?string $pluralLabel = "AJB TKR";
    protected static ?string $navigationIcon = 'heroicon-o-document';
    protected static ?string $navigationLabel = 'AJB TKR';
    protected static ?string $pluralModelLabel = 'Daftar AJB TKR';
    ...
    {
        return [
            'index' => Pages\ListAjbTkrs::route('/'),
            'create' => Pages\CreateAjbTkr::route('/create'),
            'edit' => Pages\EditAjbTkr::route('/{record}/edit'),
        ];
    }
}
